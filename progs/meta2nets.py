...
works = open(wdir+'/works.tmp','w',encoding="utf-8")
worksinfo = open(wdir+'/works.csv','w',encoding="utf-8")
authors = open(wdir+'/authors.tmp','w',encoding="utf-8")
years  = open(wdir+'/years.tmp','w')
journals  = open(wdir+'/journals.tmp','w',encoding="utf-8")
authlinks  = open(wdir+'/authlinks.tmp','w')
keywlinks  = open(wdir+'/keywlinks.tmp','w')
jourlinks  = open(wdir+'/jourlinks.tmp','w')
keywords  = open(wdir+'/keywords.tmp','w',encoding="utf-8")
...
with open('metadata.csv',newline='',encoding="utf-8") as csvfile:
   ...
   for row in csvreader:
      ...
      if len(Au)>0: firstAu = Au[0].strip()
      if len(firstAu)==0: name = "ANON"
      else: name = firstAu.split(",")[0]
...
works  = open(wdir+'/works.tmp','r',encoding="utf-8")
authors = open(wdir+'/authors.tmp','r',encoding="utf-8")
wa  = open(wdir+'/WA.net','w',encoding="utf-8")
...
works  = open(wdir+'/works.tmp','r',encoding="utf-8")
journals = open(wdir+'/journals.tmp','r',encoding="utf-8")
wj  = open(wdir+'/WJ.net','w',encoding="utf-8")
...
works  = open(wdir+'/works.tmp','r',encoding="utf-8")
keywords = open(wdir+'/keywords.tmp','r',encoding="utf-8")
wk  = open(wdir+'/WK.net','w',encoding="utf-8")
